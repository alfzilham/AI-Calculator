...
- **Decision:** Render the toggle outside `.calculator` and position it fixed at the viewport's top-left, above the sidebar overlay layer. Animate its three centered horizontal lines into an X when open.
